        ...
        <div className="ml-5 mt-10 lg:flex lg:flex-col lg:justify-center">
          <div className="h-[15vh] w-screen flex ">
            ...
            <div className="mt-5">
              ...
              <h1 className="text-base font-light opacity-70 lg:w-11/12 lg:my-5 md:my-5 md:w-11/12">Inspired by the dancing figure of Death that is commonly associated with Halloween, this unique perfume combines notes of black pepper, wormwood and jasmine to create an intense and enigmatic fragrance.</h1>
            </div>
            <button className='RedButton mb-10 w-11/12 ml-[4vw] mt-5 md:ml-0 text-lg md:text-2xl md:mb-10 lg:text-2xl lg:w-10/12 lg:mx-auto'>Download</button>
        </div>
      </div>
    </div>
  )
